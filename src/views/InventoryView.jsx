...
import { Package, Plus, Search, FileSpreadsheet, Layers, X, Compass, RefreshCw } from 'lucide-react';
...
export const InventoryView = () => {
    ...
    const fetchInventoryData = async () => {
        try {
            ...
            const totalSharshoorTons = sharshoorLogs.reduce((acc, curr) => acc + (curr.amountTons || 0), 0);
            const totalCrusherStock = crusherLogs.reduce((acc, curr) => acc + (curr.dailyProductionTons || 0), 0);
            const dynamicItems = [];
    ...
    const filteredInventory = inventory.filter(item => item.materialName.includes(searchTerm) || item.sector.includes(searchTerm));
    ...
    return (<div className="view-content">
      ...
      <div className="table-controls-bar">
        <div className="search-input-box">
          ...
          <input type="text" placeholder="بحث بنوع المادة أو القطعة..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
        </div>
      ...
      <div className="table-container" style={{ marginBottom: '2rem' }}>
        {filteredInventory.length === 0 ? (<div style={{ padding: '3rem', textAlign: 'center', color: '#64748b' }}>
            ...
            <tbody>
              {filteredInventory.map((item) => (<tr key={item.id}>
          ...
          <div className="modal-card">
            ...
            <form onSubmit={handleUpdate} className="modal-form">
              <div className="form-group">
                ...
                <input type="text" className="form-input" value={form.materialName} onChange={(e) => setForm({ ...form, materialName: e.target.value })} required/>
              </div>
              ...
              <div className="form-grid-2">
                ...
                <div className="form-group">
                  ...
                  <input type="number" className="form-input" value={form.amount} onChange={(e) => setForm({ ...form, amount: Number(e.target.value) })} required/>
                </div>
              </div>
