...
import { Search, X, ShieldCheck, UserPlus, Edit2, Trash2, Key, UserCheck } from 'lucide-react';
export const UsersView = () => {
    ...
    return (<div className="view-content" style={{ maxWidth: '1000px', margin: '0 auto' }}>
      {/* Top Header */}
            ...
            {filteredUsers.map((user) => (<tr key={user.id}>
                ...
                <td>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <button onClick={() => openEdit(user)} style={{ background: '#eff6ff', color: '#2563eb', border: '1px solid #bfdbfe', padding: '0.35rem 0.65rem', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.78rem', fontWeight: 700 }} title="تعديل المستخدم">
                      <Edit2 size={13}/>
                      <span>تعديل</span>
                    </button>
                    <button onClick={() => handleDeleteUser(user.id, user.name)} style={{ background: '#fee2e2', color: '#dc2626', border: '1px solid #fecaca', padding: '0.35rem 0.65rem', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.78rem', fontWeight: 700 }} title="حذف المستخدم">
                      <Trash2 size={13}/>
                      <span>حذف</span>
                    </button>
                  </div>
            ...
            <form onSubmit={handleAddUser} className="modal-form">
              ...
              <div className="form-grid-2">
                <div className="form-group">
                  ...
                  <input type="text" className="form-input" placeholder="admin" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required/>
                </div>
                <div className="form-group">
          ...
          <div className="modal-card" style={{ maxWidth: '480px' }}>
            ...
            <form onSubmit={handleEditUser} className="modal-form">
              ...
              <div className="form-grid-2">
                <div className="form-group">
                  <label className="form-label">اسم المستخدم (Login) <span className="required-asterisk">*</span></label>
                  <input type="text" className="form-input" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} required/>
                </div>
                <div className="form-group">
