    ...
    return (<div className="view-content">
      ...
      <div className="table-controls-bar">
        <div className="search-input-box">
          ...
          <input type="text" placeholder="بحث بالكود، اسم المعدة، السائق، أو الموقع..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
        </div>
      ...
      <div className="table-container">
        <table className="custom-table">
          ...
          <tbody>
            {filteredEquipment.map((eq) => (<tr key={eq.id}>
                ...
                <td>
                  {eq.imageUrl ? (<div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', cursor: 'pointer', background: '#f5f3ff', padding: '0.25rem 0.6rem', borderRadius: '8px', border: '1px solid #ddd6fe' }} onClick={() => setSelectedImage(eq.imageUrl)} title="انقر لتكبير صورة المعدة">
            ...
            <form onSubmit={handleAddEquipment} className="modal-form">
              <div className="form-grid-2">
                <div className="form-group">
                  ...
                  <input type="text" className="form-input" placeholder="مثال: EX-09" value={formData.code} onChange={(e) => setFormData({ ...formData, code: e.target.value })} required/>
                </div>
                <div className="form-group">
                  <label className="form-label">اسم وطراز المعدة <span className="required-asterisk">*</span></label>
                  <input type="text" className="form-input" placeholder="مثال: حفار Komatsu PC390" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} required/>
                </div>
              </div>
