  ...
  const sectorsData = [
    {
      id: 'sector-1',
      code: 'SEC-01',
      name: 'القطاع الأول (شركة حسن علام / الرواد A)',
      contractor: 'شركة حسن علام للمقاولات',
    ...
    },
    {
      id: 'sector-2',
      code: 'SEC-02',
      name: 'القطاع الثاني (شركة نيوم B)',
      contractor: 'شركة نيوم للإنشاءات والتطوير',
    ...
    },
    {
      id: 'sector-3',
      code: 'SEC-03',
      name: 'القطاع الثالث (شركة أوراسكوم C)',
      contractor: 'شركة أوراسكوم للإنشاءات',
    ...
    },
    {
      id: 'sector-4',
      code: 'SEC-04',
      name: 'القطاع الرابع (شركة الرواد D)',
      contractor: 'شركة الرواد للمقاولات العامة',
