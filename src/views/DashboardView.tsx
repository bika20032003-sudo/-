...
export const DashboardView: React.FC<DashboardViewProps> = ({ onNavigateTab }) => {
  ...
  const [activeChartTab, setActiveChartTab] = useState<'progress' | 'trends' | 'fleet'>('progress');
    ...
    <div className="view-content" style={{ maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          ...
          <button 
            onClick={() => onNavigateTab('road-progress')}
            className="secondary-action-btn" 
            style={{ padding: '0.35rem 0.75rem', fontSize: '0.82rem', height: '34px', background: '#f0fdf4', borderColor: '#bbf7d0' }}
          >
          ...
          <button 
            ...
            className="secondary-action-btn" 
            style={{ padding: '0.35rem 0.75rem', fontSize: '0.82rem', height: '34px' }}
          >
          ...
          <button 
            onClick={() => onNavigateTab('tomorrow-plan')}
            className="secondary-action-btn" 
            style={{ padding: '0.35rem 0.75rem', fontSize: '0.82rem', height: '34px', background: '#eff6ff', borderColor: '#bfdbfe' }}
          >
        ...
        <div style={{ display: 'flex', gap: '0.65rem', alignItems: 'center' }}>
          <select 
            ...
            style={{ height: '34px', fontSize: '0.82rem', padding: '0 0.65rem' }}
          >
          ...
          <button 
            ...
            onClick={() => onNavigateTab('upload-reports')}
            style={{ height: '34px', padding: '0 1rem', fontSize: '0.85rem' }}
          >
            <UploadCloud size={15} />
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.25rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '0.85rem' }}>
          ...
          <button 
            onClick={() => onNavigateTab('road-progress')}
            className="secondary-action-btn"
            style={{ background: '#fff', fontSize: '0.82rem', fontWeight: 800, color: '#2563eb', borderColor: '#bfdbfe' }}
          >
            ...
            <div style={{ position: 'relative', width: '74px', height: '74px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="74" height="74" viewBox="0 0 36 36">
                ...
                <path
                  ...
                  stroke="#38bdf8"
                  strokeWidth="3.5"
                  strokeDasharray={`${metrics.roadProgress.overallPercentage}, 100`}
                  strokeLinecap="round"
                />
              </svg>
              ...
              <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '1.25rem' }}>
                ...
                <div style={{ height: '140px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '2px solid #fed7aa', gap: '0.4rem' }}>
                  {metrics.weeklyTrends.map((trend, idx) => {
                    ...
                    return (
                      <div key={idx} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1, gap: '0.25rem' }}>
      ...
      <div style={{ 
        ...
        <div 
          ...
          onClick={() => onNavigateTab('crushers')}
          style={{ padding: '1.25rem 1.5rem', cursor: 'pointer' }}
          title="فتح قسم الكسارات"
        >
        ...
        <div 
          className="kpi-metric-card" 
          onClick={() => onNavigateTab('sharshoor')}
          style={{ padding: '1.25rem 1.5rem', cursor: 'pointer' }}
          title="فتح قسم الشرشور"
        >
          <div className="kpi-card-header">
        ...
        <div 
          ...
          style={{ padding: '1.25rem 1.5rem', cursor: 'pointer' }}
          title="فتح قسم الوقود والصهاريج"
        >
          <div className="kpi-card-header">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '1.25rem', marginBottom: '1.5rem' }}>
        ...
        <div className="dashboard-white-card" style={{ padding: '1.35rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
            ...
            <button 
              onClick={() => onNavigateTab('daily-reports')}
              style={{ background: 'none', border: 'none', color: '#2563eb', fontSize: '0.8rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.2rem' }}
            >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    {rep.imageUrl ? (
                      ...
                      <div style={{ width: '38px', height: '38px', borderRadius: '6px', background: '#eff6ff', color: '#2563eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <FileText size={18} />
                      </div>
                    )}
                    <div>
      ...
      {selectedImage && (
        ...
        >
          <div style={{ position: 'relative', maxWidth: '90vw', maxHeight: '90vh' }}>
            ...
            <img 
              src={selectedImage} 
              alt="صورة التقرير الميداني المكبرة" 
